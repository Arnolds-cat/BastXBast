...
function removeInput1(){
	...
	$(function() {
		...
		$("#list_skema1").jqGrid(
				{
					url : '/manager/json/get-bets3.action?SkemaID='+<s:property value="#session.skema3ID"/>,
					datatype : "json",
					colNames : [ 'Bet', "Played",
							"", "Cash", ""],
					colModel : [ {
...
<a	href="/admin/admin-home.action">Home</a><br>
	...
	<div id="tabs">
		...
		<div id="skema1">
			...
			Number of Events: <s:property value="#session.skema3.NEvents"/><br>
			Number of Expected Events: <s:property value="#session.skema3.NExpected"/><br>
			Number of Played Events: <s:property value="#session.skema3.played"/><br>
			Number of Successfull Events: <s:property value="#session.skema3.won"/><br>
			Initial Cash : <s:property value="#session.skema3.initialCash"/><br>
			Final Cash : <s:property value="#session.skema3.roundedFinalCash"/><br>
			Share : <s:property value="#session.skema3.share"/><br>
			...
			<s:textfield id="amount" name="playedAmount" label="The next bet amount is" readonly="true" value="%{nextBet3}"/>
			...
			<s:hidden name="skemaIDcl" value="%{#session.skema3ID}"/>
