...
function removeInput1(){
	...
	$(function() {
		...
		$("#list_skema1").jqGrid(
				{
					url : '/manager/json/get-bets1.action?SkemaID='+<s:property value="#session.skema1ID"/>,
					datatype : "json",
					colNames : [ 'Bet', "Played",
							"", "Cash", ""],
					colModel : [ {
...
<body>
	...
	<a href="/admin/userSkema2.action">Skema 2</a><br>
	</s:if>
...
<a	href="/admin/admin-home.action">Home</a><br>
	...
	<div id="tabs">
		...
		<div id="skema1">
			...
			Number of Events: <s:property value="#session.skema1.NEvents"/><br>
			Number of Expected Events: <s:property value="#session.skema1.NExpected"/><br>
			Number of Played Events: <s:property value="#session.skema1.played"/><br>
			Number of Successfull Events: <s:property value="#session.skema1.won"/><br>
			Initial Cash : <s:property value="#session.skema1.initialCash"/><br>
			Final Cash : <s:property value="#session.skema1.roundedFinalCash"/><br>
			Share : <s:property value="#session.skema1.share"/><br>
			...
			<s:hidden name="description" value="Skema 1"/>
			<s:hidden name="initialAmount" value="%{nextBet1}"/>
			<s:textfield id="amount" name="playedAmount" label="The next bet amount is" readonly="true" value="%{nextBet1}"/>
			...
			<s:hidden name="skemaIDcl" value="%{#session.skema1ID}"/>
